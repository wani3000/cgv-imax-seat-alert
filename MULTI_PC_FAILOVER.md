...
자동 감시 작업은 여러 PC에서 돌릴 수 있지만 같은 결과가 중복 전송될 수 있다. 평상시에는 주 PC만 30분 감시를 활성화하고, 예비 PC는 작업을 일시 중지해 두는 구성이 가장 안전하다. 주 PC 장애 시 예비 PC의 역할을 `primary`로 바꾸고 감시 작업을 활성화한다.
